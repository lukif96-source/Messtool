...
//   zwischengespeichert
const VERSION = 'pv-matrix-v47';   // bei Aenderungen an dieser Datei hochzaehlen
const HUELLE = ['./', './index.html', './config.js', './manifest.webmanifest',
  './css/app.css?v=20260922b', './css/pro.css?v=20260925e', './js/app.js?v=20260925c', './js/fotos.js?v=20260925b', './js/sw-registrierung.js?v=20260923b',
