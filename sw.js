...
//   zwischengespeichert
const VERSION = 'pv-matrix-v42';   // bei Aenderungen an dieser Datei hochzaehlen
const HUELLE = ['./', './index.html', './config.js', './manifest.webmanifest',
  './css/app.css?v=20260922b', './css/pro.css?v=20260924z', './js/app.js?v=20260924z', './js/fotos.js?v=20260924x', './js/sw-registrierung.js?v=20260923b',
