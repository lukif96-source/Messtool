...
//   zwischengespeichert
const VERSION = 'pv-matrix-v22';   // bei Aenderungen an dieser Datei hochzaehlen
const HUELLE = ['./', './index.html', './config.js', './manifest.webmanifest',
  './css/app.css?v=20260922b', './css/pro.css?v=20260924e', './js/app.js?v=20260924f', './js/fotos.js?v=20260924c', './js/sw-registrierung.js?v=20260923b',
