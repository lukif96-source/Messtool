...
//   zwischengespeichert
const VERSION = 'pv-matrix-v43';   // bei Aenderungen an dieser Datei hochzaehlen
const HUELLE = ['./', './index.html', './config.js', './manifest.webmanifest',
  './css/app.css?v=20260922b', './css/pro.css?v=20260925a', './js/app.js?v=20260925a', './js/fotos.js?v=20260924x', './js/sw-registrierung.js?v=20260923b',
